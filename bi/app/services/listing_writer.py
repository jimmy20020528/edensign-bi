...
def _style_context(style: str) -> str:
    contexts = {
        ...
        "Contemporary": "High contrast, strong silhouettes, matte surfaces. Restrained palette. Every element has a reason to be there.",
        "Modern Minimalist": "White, natural light, one material language throughout. Nothing extra. The empty spaces matter as much as the objects.",
        "Scandinavian": "Pale oak, off-white walls, woven textiles. Warm and functional. Hygge without being precious.",
        "Bohemian": "Layered textiles, terracotta and deep green, a mix of vintage and new. Nothing matches but everything belongs.",
        ...
        "Coastal Modern": "Clean-lined furniture, limewash or stone surfaces, warm whites. Coastal lightness with modern restraint.",
        "Farmhouse": "Shiplap whites, worn wood, apron sink, cotton textiles. Substantial and warm. The kitchen is the center.",
        "Traditional": "Deep woods, rich upholstery, symmetry, brass hardware. Composed and built to last a generation.",
    }
