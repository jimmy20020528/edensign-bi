...
Why web search:
  - Without search, GPT defaults to "Modern Minimalist #1 everywhere"
...
def _build_prompt(
    ...
    payload: dict[str, Any] = {
        "task": (
            ...
            "do NOT default to a generic 'Modern Minimalist first' ordering."
            f"{archetype_phrase}"
        ),
        "target_market": {
            "zipcode": zipcode,
        ...
        "output_constraints": {
            ...
            "diversity_requirement": (
                ...
                "If suburban family market, Farmhouse/Traditional/Transitional should rank higher. "
                "Only rank Modern Minimalist or Scandinavian #1 if research confirms it fits THIS market."
            ),
            "psf_premium_note": (
